...
-- vim.api.nvim_set_hl(0, 'qfFileName', { link = 'TextSecondary' })
-- vim.api.nvim_set_hl(0, 'qfSeparator1', { link = 'TextSecondary' })
-- vim.api.nvim_set_hl(0, 'qfSeparator2', { link = 'TextSecondary' })
