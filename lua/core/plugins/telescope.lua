...
return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      map('n', '<leader>fr', builtin.oldfiles, { desc = 'Telescope Recent (oldfiles)' })
      map('n', '<leader>t"', builtin.registers, { desc = 'Telescope Registries' })
      ...
      map('n', '<leader>of', functions.org_files, { desc = 'Search Org files' })
