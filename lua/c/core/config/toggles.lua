...
local copilot = C.global.copilot
local completion = C.global.completion
...
local toggles = {
  ...
  -- toggle autoformat
  format = function()
    C.global.autoformat = not C.global.autoformat
    print('Autoformat: ' .. tostring(C.global.autoformat))
  end,
