...
map('n', '<leader>u1', ':colorscheme ' .. UI.colorscheme_1 .. '<CR>', { desc = 'Set colorscheme 1' })
map('n', '<leader>u2', ':colorscheme ' .. UI.colorscheme_2 .. '<CR>', { desc = 'Set colorscheme 2' })
map('n', '<leader>u3', ':colorscheme ' .. UI.colorscheme_3 .. '<CR>', { desc = 'Set colorscheme 3' })
map('n', '<leader>u4', ':colorscheme ' .. UI.colorscheme_4 .. '<CR>', { desc = 'Set colorscheme 4' })
