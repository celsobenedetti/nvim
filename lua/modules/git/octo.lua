if true then
  ...
  -- UPDATE 2025-07-21: LEt's try LAzyVim octo extra
  return {}
end
      ...
      require("octo").setup({
        ...
        issues = {
          order_by = { -- criteria to sort results of `Octo issue list`
            field = "CREATED_AT", -- either COMMENTS, CREATED_AT or UDATED_AT (https://docs.github.com/en/graphql/reference/enums#issueorderfield)
        ...
        mappings = {
          ...
          review_thread = {
            ...
            close_review_tab = { lhs = "<space>Q", desc = "close review tab" },
            react_hooray = { lhs = "<space>rp", desc = "add/remove 🎉 reaction" },
            react_heart = { lhs = "<space>rh", desc = "add/remove ❤️ reaction" },
            react_eyes = { lhs = "<space>re", desc = "add/remove 👀 reaction" },
            react_thumbs_up = { lhs = "<space>r+", desc = "add/remove 👍 reaction" },
